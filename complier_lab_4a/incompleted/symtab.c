...
/* 
Calculate the size of a type in words (each word = 4 bytes)
for INT and CHAR: 1 word each
for ARRAY: arraySize * elementType size
*/
...
/*
Declare an object in the symbol table
adds the object to the current scope's object list
for variables and parameters, calculates their local offset in the stack frame
*/
