/* to build test file:
   - go to folder incompleted
   - run the following command:
     gcc -I. -DUNIT_TEST_MODE -o unit_test_scanner unit_test_scanner.c reader.c charcode.c token.c error.c -lcmocka && ./unit_test_scanner
...
// Define UNIT_TEST_MODE trước khi include scanner.c
